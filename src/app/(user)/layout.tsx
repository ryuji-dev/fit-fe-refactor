...
export default function UserLayout({ children }: { children: React.ReactNode }) {
  return (
    <main className="relative flex min-h-screen w-full items-stretch justify-center gap-40">
      ...
      <section className="hidden min-h-screen w-[600px] flex-col items-center justify-center bg-transparent xl:flex">
      ...
      <section className="flex w-full max-w-[500px] flex-col items-center">
        <div className="relative flex h-screen w-full flex-col rounded-lg bg-gray-50 shadow-2xl">
          <div className="h-[80px]" />
          <main className="scrollbar-hide w-full flex-1 overflow-auto">
